    ...
    viewport={{once:true}}>
      ...
      {!isImageLoaded &&
        <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
          <input value={input} onChange={(e)=>setInput(e.target.value)} type="text" placeholder="Describe what do you want to generate" className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' />
